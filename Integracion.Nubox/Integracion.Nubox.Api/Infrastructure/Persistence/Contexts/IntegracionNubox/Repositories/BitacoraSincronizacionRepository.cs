...
{
    public class BitacoraSincronizacionRepository : Repository<BitacoraSincronizacion, Guid>, IBitacoraSincronizacionRepository
    {
        public BitacoraSincronizacionRepository(IntegracionNuboxContext context) : base(context)
        {
        }
    }
